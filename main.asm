...
----------------------------------------------------------
*/
.SDSCTAG 3.00, sdscName, sdscDesc, sdscAuth
...
----------------------------------------------------------
*/
.SECTION "ANNA AND BABY OTTO TILES (UNCOMPRESSED)" BANK SOUND_BANK SLOT 2 FREE
    annaTileS13:
    annaTileA14:
        .DSB $20, $00
...
.SECTION "UNCOMPRESSED TILES FOR PLAYER SPRITES" BANK UNCOMP_BANK SLOT 2 FREE
    ; EMPTY TILE
    pacTileS07:
    pacDTileS0F:
    ottoTileS23:
